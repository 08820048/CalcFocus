...
export default function VideoEditor() {
	...
	return (
		<div className="flex flex-col h-screen bg-[#09090b] text-slate-200 overflow-hidden selection:bg-[#09cf67]/30">
						...
						<div className="flex">
							...
							<PopoverTrigger asChild>
								<Button
									type="button"
									size="sm"
									className="h-7 w-7 p-0 rounded-l-none border-l border-[#09cf67]/50 bg-[#09cf67] text-white hover:bg-[#09cf67]/90 active:scale-[0.98] transition-all"
								>
								...
								<div className="flex items-center gap-2">
									<button
										...
										className={cn(
											...
											exportFormat === "mp4"
												? "bg-[#09cf67]/10 border-[#09cf67]/50 text-white"
										...
										<div className="flex items-center justify-between">
											...
											<div className="flex items-center gap-2">
												...
												<Switch
													...
													className="data-[state=checked]:bg-[#09cf67] scale-75"
												/>
											</div>
										</div>
									</div>
