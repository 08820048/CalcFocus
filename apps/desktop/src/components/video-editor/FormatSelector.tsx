				...
				return (
					<button
						...
						className={cn(
							...
							"focus:outline-none focus:ring-2 focus:ring-[#09cf67]/50 focus:ring-offset-2 focus:ring-offset-[#09090b]",
							isSelected
					...
					>
						<div
							className={cn(
								...
								isSelected ? "bg-[#09cf67]/20 text-[#09cf67]" : "bg-white/5",
							)}
						>
							{option.icon}
						</div>
						...
						{isSelected && (
							<div className="absolute top-2 right-2 w-2 h-2 rounded-full bg-[#09cf67]" />
						)}
					</button>
				);
			})}
