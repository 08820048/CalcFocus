...
function PlaybackCursor({
	...
	return (
		...
		>
			<div
				className="absolute top-0 bottom-0 w-[2px] bg-[#09cf67] shadow-[0_0_10px_rgba(9,207,103,0.5)] cursor-ew-resize pointer-events-auto hover:shadow-[0_0_15px_rgba(9,207,103,0.7)] transition-shadow"
				style={{
			...
			>
				...
				>
					<div className="w-3 h-3 mx-auto mt-[2px] bg-[#09cf67] rotate-45 rounded-sm shadow-lg border border-white/20" />
				</div>
				{isDragging && (
						...
						<div className="flex flex-col items-center pb-1">
							...
							<span
								className={cn(
									...
									marker.time === currentTimeMs ? "text-[#09cf67]" : "text-slate-500",
								)}
							>
								{marker.label}
							</span>
						...
						<DropdownMenuContent align="end" className="bg-[#1a1a1a] border-white/10">
							{ASPECT_RATIOS.map((ratio) => (
								...
								>
									...
									{aspectRatio === ratio && <Check className="w-3 h-3 text-[#09cf67]" />}
								</DropdownMenuItem>
							))}
