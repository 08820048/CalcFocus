...
export function normalizeProjectEditor(editor: Partial<ProjectEditorState>): ProjectEditorState {
	...
	return {
		...
		audioMuted:
			typeof (editor as Partial<ProjectEditorState>).audioMuted === "boolean"
				? ((editor as Partial<ProjectEditorState>).audioMuted as boolean)
				: DEFAULT_AUDIO_MUTED,
		audioVolume: isFiniteNumber((editor as Partial<ProjectEditorState>).audioVolume)
			? clamp((editor as Partial<ProjectEditorState>).audioVolume as number, 0, 1)
			: DEFAULT_AUDIO_VOLUME,
