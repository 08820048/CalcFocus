...
export function AnnotationOverlay({
	...
	const renderArrow = () => {
		...
		const color = annotation.figureData?.color || "#09cf67";
	...
	return (
		<Rnd
			...
			className={cn(
				...
				isSelected && "ring-2 ring-[#09cf67] ring-offset-2 ring-offset-transparent",
			)}
			style={{
			...
			resizeHandleStyles={{
				topLeft: {
					...
					border: isSelected ? "2px solid #09cf67" : "none",
					borderRadius: "50%",
					left: "-6px",
					top: "-6px",
					cursor: "nwse-resize",
