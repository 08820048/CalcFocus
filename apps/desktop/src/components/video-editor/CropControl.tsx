	...
	const handlePointerUp = (e: React.PointerEvent) => {
		if (isDragging) {
			try {
				...
				// Pointer may already be released when the drag ends outside the handle.
			}
		}
		setIsDragging(null);
	};
	...
	return (
		<div className="w-full p-8">
			...
			>
				...
				<div
					className={cn("absolute h-[3px] cursor-ns-resize z-20 pointer-events-auto bg-[#09cf67]")}
					style={{
						left: `${cropPixelX}%`,
						top: `${cropPixelY}%`,
						width: `${cropPixelWidth}%`,
				...
				<div
					className={cn("absolute w-[3px] cursor-ew-resize z-20 pointer-events-auto bg-[#09cf67]")}
					style={{
						left: `${cropPixelX}%`,
						top: `${cropPixelY}%`,
						height: `${cropPixelHeight}%`,
