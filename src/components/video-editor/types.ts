...
export type ZoomTransitionEasing = "calcfocus" | "glide" | "smooth" | "snappy" | "linear";
...
export const DEFAULT_ZOOM_IN_EASING: ZoomTransitionEasing = "calcfocus";
export const DEFAULT_ZOOM_OUT_EASING: ZoomTransitionEasing = "calcfocus";
