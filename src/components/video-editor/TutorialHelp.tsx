...
import {
	...
	CALCFOCUS_ISSUES_URL,
	CALCFOCUS_QQ_URL,
	CALCFOCUS_WEBSITE_URL,
	openExternalLink,
} from "./tutorialHelpShared";

const CALCFOCUS_DISCORD_URL = "";
						...
						<div className="flex items-center justify-between gap-3 rounded-lg border border-white/5 bg-white/5 px-3 py-3">
							<div>
								<p className="text-[11px] uppercase tracking-[0.18em] text-slate-500">
									{t("feedback.websiteLabel", "Website")}
								</p>
