				...
				return (
					<button
						...
						className={cn(
							...
							"focus:outline-none focus:ring-2 focus:ring-[#4bbd7e]/50 focus:ring-offset-2 focus:ring-offset-[#09090b]",
							isSelected
								? "bg-[#4bbd7e]/10 border-[#4bbd7e]/50 text-white"
					...
					>
						<div
							className={cn(
								...
								isSelected ? "bg-[#4bbd7e]/20 text-[#4bbd7e]" : "bg-white/5",
							)}
						>
							{option.icon}
						</div>
						...
						{isSelected && (
							<div className="absolute top-2 right-2 w-2 h-2 rounded-full bg-[#4bbd7e]" />
						)}
					</button>
				);
			})}
