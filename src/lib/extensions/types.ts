/**
 * CalcFocus Extension System — Core Types
 *
...
// ---------------------------------------------------------------------------
// Extension Manifest (calcfocus-extension.json)
// ---------------------------------------------------------------------------
...
export interface ExtensionManifest {
	...
	license?: string;
	/** Minimum CalcFocus version required */
	engine?: string;
 ...
 *
 * CalcFocus does not auto-register these entries at runtime today.
...
export interface CalcFocusExtensionAPI {
...
export interface CalcFocusExtensionModule {
	/** Called when the extension is activated */
	activate(api: CalcFocusExtensionAPI): void | Promise<void>;
